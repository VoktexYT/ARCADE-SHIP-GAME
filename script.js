class Main extends Phaser.Scene {
    ...
    create() {
        ...
        this.score = this.add.text(0, 0, '', {fontSize: 80, fontFamily: 'pixelMoney'}).setTint(0xd0d058);
    }
    ...
    update() {
        ...
        if (this.shipLife != 0) {
            this.score = this.add.text(400, 130, this.score_int.toString(), {fontSize: 80, fontFamily: 'pixelMoney'}).setTint(0xd0d058);
        }
